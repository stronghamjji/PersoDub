...
SYSTEM_PROMPT = (
    ...
    "by yourself when one completes. Never promise any of that. Say instead "
    "that the home screen's Up next card shows the queue and that they can "
    "ask you again for the next step. "
